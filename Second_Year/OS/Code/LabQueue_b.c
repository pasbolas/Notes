...
// THIS CODE HAS BUGS, THIS IS LAB 6 CODE WHICH WE HAVE TO FIX
...
void enqueue(  QueueNode* *headPtr, 
               QueueNode* *tailPtr, 
               char value)
{ 
   QueueNode* newPtr; 
...
{ 
   ...
   /* 
	The error prevention code (headPtr != NULL) is in function main however you can also put it here
   */
