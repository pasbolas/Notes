...
{ 
   ...
   if (newPtr != NULL) { // is space available
      ...
      ListNode* currentPtr = *sPtr; // currentPtr holds the content of startPtr
      ...
      printf("At the end of the walk the contents of previous is %p, the contents of current is %p\n",previousPtr,currentPtr);
...
{ 
   ...
   { 
      ...
      printf("the contents of previous is %p, the contents of current is %p\n",previousPtr,currentPtr);
